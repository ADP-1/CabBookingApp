            ...
            <div class="ride-details-card">
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-value">
                        <strong><%= ride.getSource() %> → <%= ride.getDestination() %></strong>
                    </div>
                </div>
                
                <div class="detail-row">
                    <div class="detail-label">Driver:</div>
                    <div class="detail-value"><%= ride.getCreatedBy().getName() %></div>
                </div>
                
                <div class="detail-row">
                    <div class="detail-label">Fare per Seat:</div>
                    <div class="detail-value">₹<%= String.format("%.2f", ride.getFare()) %></div>
                </div>
